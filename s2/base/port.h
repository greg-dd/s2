...
// NOTE ON ADAPTING TO OUR CODEBASE ------------------------------------------
// This file contains many macros and global variables prone to conflicting with
// our existing repository. Most of what is defined here is non-essential for compiling
// the S2 library. All non-essential code was commented out. All essential was changed
// to be either within the s2 namespace, or, when it comes to macros, was prefixed
// with S2_.
// -----------------------------------------------------------------------------
...
#if 0
namespace s2 {
static inline s2::uint16 bswap_16(s2::uint16 x) {
#ifdef __cplusplus
  return static_cast<s2::uint16>(((x & 0xFF) << 8) | ((x & 0xFF00) >> 8));
#else
  return (s2::uint16)(((x & 0xFF) << 8) | ((x & 0xFF00) >> 8));  // NOLINT
#endif  // __cplusplus
}
#define bswap_16(x) bswap_16(x)
static inline s2::uint32 bswap_32(s2::uint32 x) {
  return (((x & 0xFF) << 24) |
          ((x & 0xFF00) << 8) |
          ((x & 0xFF0000) >> 8) |
          ((x & 0xFF000000) >> 24));
...
static inline uint64 bswap_64(s2::uint64 x) {
  return (((x & 0xFFULL) << 56) |
          ((x & 0xFF00ULL) << 40) |
          ((x & 0xFF0000ULL) << 24) |
          ((x & 0xFF000000ULL) << 8) |
...
// Use these macros after a % in a printf format std::string
...
inline uint16 S2_UNALIGNED_LOAD16(const void *p) {
  return __sanitizer_unaligned_load16(p);
}

inline uint32 S2_UNALIGNED_LOAD32(const void *p) {
  return __sanitizer_unaligned_load32(p);
}

inline uint64 S2_UNALIGNED_LOAD64(const void *p) {
  return __sanitizer_unaligned_load64(p);
}

inline void S2_UNALIGNED_STORE16(void *p, uint16 v) {
  __sanitizer_S2_unaligned_store16(p, v);
}

inline void S2_UNALIGNED_STORE32(void *p, uint32 v) {
  __sanitizer_unaligned_store32(p, v);
}

inline void S2_UNALIGNED_STORE64(void *p, uint64 v) {
...
inline void S2_UNALIGNED_STORE16(void *p, uint16 v) { memcpy(p, &v, sizeof v); }

inline void S2_UNALIGNED_STORE32(void *p, uint32 v) { memcpy(p, &v, sizeof v); }

inline void S2_UNALIGNED_STORE64(void *p, uint64 v) { memcpy(p, &v, sizeof v); }
...
#define S2_UNALIGNED_LOAD16(_p) (*reinterpret_cast<const s2::uint16 *>(_p))
#define S2_UNALIGNED_LOAD32(_p) (*reinterpret_cast<const s2::uint32 *>(_p))
#define S2_UNALIGNED_LOAD64(_p) (*reinterpret_cast<const s2::uint64 *>(_p))

#define S2_UNALIGNED_STORE16(_p, _val) (*reinterpret_cast<s2::uint16 *>(_p) = (_val))
#define S2_UNALIGNED_STORE32(_p, _val) (*reinterpret_cast<s2::uint32 *>(_p) = (_val))
#define S2_UNALIGNED_STORE64(_p, _val) (*reinterpret_cast<s2::uint64 *>(_p) = (_val))
...
#define S2_UNALIGNED_LOAD16(_p) \
  ((reinterpret_cast<const ::s2::base::internal::Unaligned16Struct *>(_p))->value)
#define S2_UNALIGNED_LOAD32(_p) \
  ((reinterpret_cast<const ::s2::base::internal::Unaligned32Struct *>(_p))->value)

#define S2_UNALIGNED_STORE16(_p, _val)                                        \
  ((reinterpret_cast< ::s2::base::internal::Unaligned16Struct *>(_p))->value = \
       (_val))
#define S2_UNALIGNED_STORE32(_p, _val)                                        \
  ((reinterpret_cast< ::s2::base::internal::Unaligned32Struct *>(_p))->value = \
       (_val))
...
// The S2_UNALIGNED_LOADW and UNALIGNED_STOREW macros load and store values
// of type uword_t.
#ifdef _LP64
#define S2_UNALIGNED_LOADW(_p) S2_UNALIGNED_LOAD64(_p)
#define S2_UNALIGNED_STOREW(_p, _val) S2_UNALIGNED_STORE64(_p, _val)
#else
#define S2_UNALIGNED_LOADW(_p) S2_UNALIGNED_LOAD32(_p)
#define S2_UNALIGNED_STOREW(_p, _val) S2_UNALIGNED_STORE32(_p, _val)
#endif

namespace s2 {
inline void UnalignedCopy16(const void *src, void *dst) {
  S2_UNALIGNED_STORE16(dst, S2_UNALIGNED_LOAD16(src));
}

inline void UnalignedCopy32(const void *src, void *dst) {
  S2_UNALIGNED_STORE32(dst, S2_UNALIGNED_LOAD32(src));
}

inline void UnalignedCopy64(const void *src, void *dst) {
  if (sizeof(void *) == 8) {
    S2_UNALIGNED_STORE64(dst, S2_UNALIGNED_LOAD64(src));
  } else {
    const char *src_char = reinterpret_cast<const char *>(src);
    char *dst_char = reinterpret_cast<char *>(dst);

    S2_UNALIGNED_STORE32(dst_char, S2_UNALIGNED_LOAD32(src_char));
    S2_UNALIGNED_STORE32(dst_char + 4, S2_UNALIGNED_LOAD32(src_char + 4));
  }
}
}  // namespace s2
