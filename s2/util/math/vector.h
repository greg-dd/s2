...
template <typename T>
class Vector2
    : public s2::util::math::internal_vector::BasicVector<Vector2, T, 2> {
 private:
  using Base = s2::util::math::internal_vector::BasicVector<s2::Vector2, T, 2>;
  using VType = T;
...
template <typename T>
class Vector3
    : public s2::util::math::internal_vector::BasicVector<Vector3, T, 3> {
 private:
  using Base = s2::util::math::internal_vector::BasicVector<s2::Vector3, T, 3>;
  using VType = T;
...
template <typename T>
class Vector4
    : public s2::util::math::internal_vector::BasicVector<Vector4, T, 4> {
 private:
  using Base = s2::util::math::internal_vector::BasicVector<s2::Vector4, T, 4>;
  using VType = T;
